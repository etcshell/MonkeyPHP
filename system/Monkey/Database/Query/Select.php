...
class Select
{
    ...
    public function __clone()
    {
        ...
        $this->where->setQueryIdentifierAfterClone($this->queryIdentifier);
        $this->having->setQueryIdentifierAfterClone($this->queryIdentifier);
    }
    ...
    {
        $this->where->whereField($fieldName,$fieldValue,$operator);
        return $this;
    }
    ...
    {
        $this->where->whereField($fieldName, NULL, 'IS NULL');
        return $this;
    }
    ...
    {
        $this->where->whereField($fieldName, NULL, 'IS NOT NULL');
        return $this;
    }
    ...
    {
        $this->where->whereCondition($snippet, $args);
        return $this;
    }
    ...
    public function whereExists(Select $select) {
        $this->where->whereField( '', $select, 'EXISTS');
        return $this;
    }
    ...
    public function whereNotExists(Select $select) {
        $this->where->whereField( '', $select, 'NOT EXISTS');
        return $this;
    }
     ...
     * @return $this
     */
    public function havingField($fieldName, $fieldValue = NULL, $operator = NULL)
    {
        $this->having->whereField($fieldName, $fieldValue, $operator);
        return $this;
    }
     ...
     * @return $this
     */
    public function havingFieldIsNull($fieldName)
    {
        $this->having->whereField($fieldName, NULL, 'IS NULL');
        return $this;
    }
     ...
     * @return $this
     */
    public function havingFieldIsNotNull($fieldName)
    {
        $this->having->whereField($fieldName, NULL, 'IS NOT NULL');
        return $this;
    }
    ...
    {
        $this->having->whereCondition($snippet, $args);
        return $this;
    }
