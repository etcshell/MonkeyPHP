...
/**
 * Library\ExcelReader
 * @category   EXCEL表格读取工具
 * @package    扩展库
 * @author     HuangYi
 * @copyright  Copyright (c) 2012-4-1——至今
 * @license    New BSD License
 * @version    $Id: Library\ExcelReader.php 版本号 2013-1-1  $
 *
 */
/**
 * Excel 读写类
			...
			for($col=1;$col<=$this->colcount($sheet);$col++) {
				...
				if(!$this->sheets[$sheet]['cellsInfo'][$row][$col]['dontprint']) {
					...
					if ($val=='') { $val="&nbsp;"; }
						...
						$val = htmlentities($val, ENT_NOQUOTES, $this->_defaultEncoding); // 2012-04-19 maojianlw@139.com
