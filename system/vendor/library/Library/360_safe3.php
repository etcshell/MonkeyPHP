...
function sql_encode($string) {
    ...
    return preg_replace_callback($attack, create_function('$matches', 'return str_replace(' . 'array("&","<",">","#","(",")","[","]",",","\n","--"," ")' . ',' . 'array("&#amp;","&#lt;","&#gt;","&#23;","&#28;","&#29;","&#5B;","&#5D;","&#2C;","&#0A;","&#-#;","&#20;")' . ',$matches[0]);'), $string);
}
...
function sql_decode($data) {
    ...
    if (is_array($data)) {
        return array_map('sql_decode', $data);
    }
    if (!is_string($data)) {
        return $data;
    }
