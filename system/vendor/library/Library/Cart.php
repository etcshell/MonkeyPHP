...
class Cart {
    ...
    private $cookier; //wy_cookie对象
    private $cartName = 'wy_shopping_cart'; //购物车名称
    /**
     * 购物车
     * @param Cookie $cookier //wy_cookie对象
     * @param string $cartName //购物车名称
     */
    public function __construct(Cookie $cookier, $cartName = NULL) {
    ...
    public function readCart() {
        //从购物车cookie中读取数据
        $data = $this->cookier->get($this->cartName);
        if (!$data) {
            return false;
        }
        return $data;
    ...
    public function add($id, $product = null, $num = 1, $price = null, $options = array()) {
        ...
        $this->cookier->set($this->cartName, $data);
        return true;
    }
    ...
    public function insert($data) {
        ...
        $this->cookier->set($this->cartName, $cartData);
        return true;
    }
    ...
    public function clear() {
        $this->cookier->delete($this->cartName);
    }
