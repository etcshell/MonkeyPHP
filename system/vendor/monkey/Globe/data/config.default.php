...
return array('timezone' => 'PRC', 'response_charset' => 'UTF-8', 'domain' => '', //网站主域名

    'cache' => array('default_provider' => 'file', 'file' => '\Monkey\Cache\File', 'memcache' => '\Monkey\Cache\Memcache', 'apc' => '\Monkey\Cache\Apc',), 'cache_file' => array('expire' => 3600, //默认缓存时间
    ...
    'database' => array('default_provider' => 'default', 'default' => '\Monkey\Database\Database',), 'database_default' => array('default_connection' => 'master', //链接池子
        'pool' => array('master' => 1, //本数组采用了键值倒置设计，目的是方便操作和提高检索速度
            'sqlite' => 1, //后面的值 1 是随便设置的值，只要是TRUE类型都可以
        ...
        'master' => array('protocol' => 'mysql', //数据库协议
            ...
            'dbname' => 'test', 'unix_socket' => '', 'charset' => 'utf8', //字符集设置
        ...
        'sqlite' => array('protocol' => 'sqlite', //数据库协议
    ...
    'view' => array('default_provider' => 'default', 'default' => '\Monkey\View\View',), 'view_default' => array('charset' => 'UTF-8', //
        ...
        //分页栏配置：
        'page_style_name' => 'def', 'def_link' => '<a href="{urlPre}{number}">{text}</a>', 'def_link_ajax' => '<a href="javascript:ajaxActionName(\'{urlPre}{number}\')">{text}</a>', 'def_span_current' => '<span class="current_style">{number}</span>', 'def_span_total' => '<span class="total_style">共{number}页</span>', 'def_input_jump' => '转到<input type="text" class="jump_style" size="2" title="输入页码，按回车快速跳转" value="1" onkeydown="if(event.keyCode==13) {window.location=\'{urlPre}\'+this.value; doane(event);}" />', 'def_text_first' => '首页', //另外，图片可以设置为：'<img src="..." width="16" height="11" />'，下同
