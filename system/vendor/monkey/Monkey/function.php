...
function file_real_type($filename) {
    static $typeMap = array('-48-49' => 'doc|xls', '7790' => 'exe', '7784' => 'midi', '8075' => 'zip', '8297' => 'rar', '7173' => 'gif', '255216' => 'jpg', '6677' => 'bmp', '13780' => 'png', '104116' => 'txt',);
...
function intercept_DDOS() {
    ...
    if (in_array($ip . "\r\n", $filehtarr)) {
        exit("Warning:" . "<br>" . "Your IP address are forbided by some reason, IF you have any question Pls emill to shop@mydalle.com!");
    }
    //加入禁止IP
    $time = time();
