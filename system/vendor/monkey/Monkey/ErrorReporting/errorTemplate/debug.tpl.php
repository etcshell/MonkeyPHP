...
<div class="m_box">
    ...
    <div class="m_line">
        调用信息如下：
        <pre><?php echo $errorInfo['backtrace'] ?></pre>
    </div>

    <div class="m_back">
        您可以选择跳转到<a href="<?php echo $errorInfo['goto_index'] ?>">首页</a><a href="<?php $_SERVER['PHP_SELF'] ?>"
                                                                          title="重试">重试</a><a
            href="javascript:history.back()" title="返回">返回</a>
    </div>
</div>
</body>
</html>