...
class Select {
    ...
    public function fields($fields = array()) {
        ...
        return $this->actionAddFields($this->mainTableAlias, $fields);
    }
    ...
    public function addField($tableAlias, $field, $alias = NULL) {
        ...
        $this->actionAddField($tableAlias, $field, $alias);
    ...
    public function addFields($tableAlias, $fields = array()) {
        //修复表别名
        $tableAlias = $this->checkTableAlias($tableAlias);
        $this->actionAddFields($tableAlias, $fields);
    ...
    protected function actionAddField($tableAlias, $field, $alias = NULL) {
    ...
    protected function actionAddFields($tableAlias, $fields = array()) {
        if (empty($fields)) {
        ...
        foreach ($fields as $key => $field) {
            if (is_numeric($key)) {
                $this->actionAddField($tableAlias, $field);
            }
            else {
                $this->actionAddField($tableAlias, $key, $field);
            }
        }
